...
print("Часть 1. Удаляем из итоговой таблицы поле label_id")
print(jd.head())
train = pd.DataFrame()
test = pd.DataFrame()
train = len(X_train.data)
print("Часть 2.Количество обучающих и тестовых данных")
print('Количество тренировочных данных', train)
test = len(X_test.data)
print('Количество тестовых данных', test)
print("Часть 3. Построение круговой диаграммы")
